...
<%
	...
	try {
		...
		*/
		...
		file_id = multi.getFilesystemName("file_name"); // name=file1의 업로드된 시스템 파일명을 구함(중복된 파일이 있으면, 중복 처리 후 파일 이름)
		file_name = multi.getOriginalFileName("file_name"); // name=file1의 업로드된 원본파일 이름을 구함(중복 처리 전 이름)
...
<html>
<body>
	<form action="../updateAction.bo" method="get" id="filecheck">
