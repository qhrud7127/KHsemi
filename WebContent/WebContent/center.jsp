		...
		<div class="container">
			<div class="nav">
				<div class="last">
					<h3>학교안내</h3>
					<ul>
						<li><a href="left.jsp?principal">인삿말</a></li>
						<li><a href="left.jsp?eduGoal">교육목표</a></li>
						<li><a href="left.jsp?schoolReport">학교현황</a></li>
						<li><a href="left.jsp?teachers">교직원소개</a></li>
						<li><a href="left.jsp?song">교가</a></li>
						<li><a href="left.jsp?schoolView">학교둘러보기</a></li>
						<li><a href="left.jsp?howToGet">오시는길</a></li>
					</ul>
				</div>
				<div class="last">
					<h3>학생마당</h3>
